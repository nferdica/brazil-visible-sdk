...
## Project Overview
TypeScript SDK for unified access to 93+ Brazilian public data sources. Wraps REST APIs, CSV downloads, FTP archives and geospatial services behind a single `import { ibge, bcb } from 'brazilvisible'` interface.
